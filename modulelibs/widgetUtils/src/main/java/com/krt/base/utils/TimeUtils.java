...
import com.krt.base.utils.constant.TimeConstants;
...
public final class TimeUtils {
     ...
     * 格式的意义如下： 日期和时间模式 <br>
     * <p>日期和时间格式由日期和时间模式字符串指定。在日期和时间模式字符串中，未加引号的字yy-MM-dd HH:mm母 'A' 到 'Z' 和 'a' 到 'z'
    ...
    private static final DateFormat YEAR_AND_MONTH_FORMAT = new SimpleDateFormat("yyyy年MM月", Locale.getDefault());

    private static final DateFormat MONTH_DAY_HOUR_MINUTE_FORMAT = new SimpleDateFormat("MM-dd HH:mm", Locale.getDefault());

    private static final DateFormat YEAR_MONTH_DAY_FORMAT = new SimpleDateFormat("yyyy-MM-dd", Locale.getDefault());

    private static final DateFormat MONTH_DAY_FORMAT = new SimpleDateFormat("MM月dd日", Locale.getDefault());

    private static final DateFormat HOUR_MINUTE_FORMAT = new SimpleDateFormat("HH:mm", Locale.getDefault());
     ...
     * @return 时间字符串
     */
    public static String date2StringByYearAndMonth(final Date date) {
        return date2String(date, YEAR_AND_MONTH_FORMAT);
    }
    ...
    @SuppressLint("SimpleDateFormat")
    public static String formatTimeStampWithMonthDayHourMinute(long time) {
        Date date = new Date(time);
        return MONTH_DAY_HOUR_MINUTE_FORMAT.format(date);
    }
    ...
    public static boolean isTheSameDay(long day1, long day2) {
        String szDay1 = YEAR_MONTH_DAY_FORMAT.format(new Date(day1));
        String szDay2 = YEAR_MONTH_DAY_FORMAT.format(new Date(day2));
        return szDay1.equals(szDay2);
    }

    /**
     * 是否为同一年
     */
    public static boolean isTheSameYear(long time1, long time2) {
        return new Date(time1).getYear() == new Date(time2).getYear();
    }
     ...
     * 格式化成  月、日
     */
    public static String formatMonthAndDay(long time) {
        Date date = new Date(time);
     ...
     * 格式化成  年、月、日
     */
    public static String formatYearMonthAndDay(long time) {
        Date date = new Date(time);
    ...
    public static String remainingTime(long time) {
        ...
        int minute = (int) ((remaining - hour * 1000 * 60 * 60) / 60 / 1000);

        return hour + "小时" + minute + "分钟";
    }

    //相比现在的 过去时间
    public static String hasPastTime(long time) {
     ...
     * 天、时、分
     */
    public static String formatTimeByDayHourMin(long mss) {
        String DateTimes;
     ...
     * 天、时、分、秒
     */
    public static String formatTimeByDayHourMinSec(long mss) {
        String DateTimes;
        long days = mss / (60 * 60 * 24);
        long hours = (mss % (60 * 60 * 24)) / (60 * 60);
        long minutes = (mss % (60 * 60)) / 60;
