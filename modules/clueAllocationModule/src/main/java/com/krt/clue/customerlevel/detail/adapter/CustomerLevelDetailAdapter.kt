package com.krt.clue.customerlevel.detail.adapter
...
class CustomerLevelDetailAdapter :
        BaseQuickAdapter<CustomerLevelEntity, BaseViewHolder>(R.layout.clue_item_customer_level_detail_view, null) {
    ...
    override fun convert(helper: BaseViewHolder, item: CustomerLevelEntity) {
        ...
        helper.getView<TextView>(R.id.customer_name).text = item.infoSource
